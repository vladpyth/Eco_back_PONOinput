...
public final class ListDtos {
    ...
    public record MagasinFactoryListDto(
            ...
            int value,
            Boolean new_base,
            String date_approve_tech,
            String date_input_update,
            String admissions_by_region,
            String services,
            String note_services,
            Boolean mobile_unit,
            Boolean excluded,
            LocalDate date_excluded,
            String note_excluded,
            Boolean burning) {}
    ...
    public static MagasinFactoryListDto from(MagasinFactory value) {
        return new MagasinFactoryListDto(
                ...
                value.getYNP(), value.getValue(), value.getNew_base(), value.getDate_approve_tech(),
                value.getDate_input_update(), value.getAdmissions_by_region(), value.getServices(),
                value.getNote_services(), value.getMobile_unit(), value.getExcluded(),
                value.getDate_excluded(), value.getNote_excluded(), value.getBurning());
    }
    ...
    public static TechnologyListDto from(Technology value) {
        return new TechnologyListDto(
                ...
                value.getId_technology(), value.getGet(), value.getSpot());
    }
